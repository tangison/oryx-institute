    ...
    <PageShell>
          ...
          return (
            <div key={school.slug} className="mb-16 last:mb-0">
              <div className="flex items-baseline justify-between gap-4 mb-6 pb-4 border-b border-[var(--color-border)]">
                <div>
                  <span className="font-display text-sm text-[var(--oryx-maroon)] tabular-nums">
                    {school.index}
                  </span>
                ...
                <Link
                  ...
                  className="text-sm font-medium text-[var(--muted-foreground)] hover:text-[var(--oryx-maroon)] transition-colors whitespace-nowrap"
                >
                  View school →
                </Link>
              </div>
                  ...
                  {schoolProgrammes.map((p) => (
                    <li key={p.slug} className="bg-white">
                      <Link
                        ...
                        className="block p-6 h-full hover:bg-[var(--color-oryx-cream)]/40 transition-colors group"
                      >
                        ...
                        <h3 className="font-display text-lg font-medium leading-tight mb-3 group-hover:text-[var(--oryx-maroon)] transition-colors">
                          {p.name}
                        </h3>
      ...
      <Section tone="dark">
        <div className="max-w-3xl">
          <p className="eyebrow text-[var(--oryx-warm-white)] mb-4">A note on the catalogue</p>
