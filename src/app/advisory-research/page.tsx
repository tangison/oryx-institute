...
export const metadata: Metadata = {
  title: 'Oryx Advisory & Research',
  description:
    'Oryx Advisory & Research: applied research, workforce studies, and advisory services for Namibian employers, institutions, and development partners.',
  alternates: { canonical: 'https://oryxinstitute.org/advisory-research' },
};

export default function AdvisoryResearchPage() {
  return (
    <PageShell>
      <ImagePageHeader
        eyebrow="Division"
        title="Oryx Advisory & Research."
        lede="Applied research, workforce studies, and advisory services for Namibian employers, institutions, and development partners. The employer and research division of Oryx Institute."
          ...
          <div className="lg:col-span-6 space-y-8">
            <div>
              ...
              <p className="text-[var(--muted-foreground)] leading-relaxed text-pretty">
                Oryx Advisory & Research is the employer and research division of Oryx Institute.
                It intends to conduct applied research and advisory work alongside the institution's
                teaching programmes. Research will be small in scale at launch, focused on workforce
                studies, sector needs analysis, and advisory services for employers, donors, and
                public institutions. No research project is confirmed at this stage. All research
                will be commissioned and paid for, not speculative.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-[var(--muted-foreground)] leading-relaxed text-pretty">
                ...
                deliver to a high standard. Research outputs will be published where appropriate
                and retained as confidential where required by the commissioning party. No
                research is conducted until the institution is established.
              </p>
            </div>
