    ...
    <form onSubmit={onSubmit} className="bg-white border border-[var(--color-border)] p-6 md:p-8 lg:p-10 space-y-5" noValidate>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input id="e-email" name="email" type="email" required className="input-oryx" autoComplete="email" spellCheck={false} value={form.email} onChange={(e) => update('email', e.target.value)} />
